    ...
    public partial class Form07SumarNumeros : Form
    {
        ...
        private void btnSumar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < textoSuma.Length; i++)
            {
                ...
                //Convertimos el caracter en numero
                //Podemos usar a parte de parseint el = Convert.ToInt32(caracter);
                int numero = int.Parse(caracter.ToString());
                suma += numero;
            }
            this.lblSuma.Text ="La suma de " + textoSuma + " es igual a " + suma.ToString();
        }
    }
}
